...
public class MultiChatController implements Runnable{
    ...
    // 소켓 연결을 위한 변수 선언
    private String ip = "172.16.164.101";
        ...
        v.addButtonActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (obj == v.exitButton) {
                    ...
                    status = false; // 로그아웃 status = false
                } else if (obj == v.msgInput) {
                    // 입력된 메시지 전송 (위의 로그아웃 메시지 전송코드와 Message 생성자 참고),출력 스트림에 전달
    ...
    public static void main(String[] args) {
        ...
        MultiChatController mcc = new MultiChatController(new MultiChatData(),new MultiChatUI());
        mcc.appMain();
    }
}
